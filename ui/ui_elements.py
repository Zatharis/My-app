...
def create_entry(parent, font, bg="#e5c3cc"):
    return Entry(parent, font=font, bg=bg)
...
def create_listbox(parent, font, bg="#f5dfe8"):
    return Listbox(parent, font=font, bg=bg)
